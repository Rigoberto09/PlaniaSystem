...
{
    /// <inheritdoc />
    public partial class SistemaPlania1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__8A3D240C1FC10DD9", x => x.idCategoria);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rol__3C872F76861FDFFE", x => x.idRol);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__07F4A13252CE9C39", x => x.idProducto);
                    table.ForeignKey(
                        name: "FK__Producto__idCate__1920BF5C",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Usuario__645723A63F6E1A5F", x => x.idUsuario);
                    table.ForeignKey(
                        name: "FK__Usuario__idRol__1367E606",
                        column: x => x.idRol,
                        principalTable: "Rol",
